...
7. Work24 is limited to NCS division `20` and course-type codes `C0061`, `C0104`, and `C0105` for
   general 국민내일배움카드 and K-Digital options. Other program classes are outside this MVP.
